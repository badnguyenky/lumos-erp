...
class AppStateNotifier extends ChangeNotifier {
  ...
  void update(LumosAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'ChonChucNang',
          path: '/chonChucNang',
          builder: (context, params) => ChonChucNangWidget(
            gusId: params.getParam(
              'gusId',
              ParamType.int,
            ),
            ounId: params.getParam(
              'ounId',
              ParamType.int,
            ),
          ),
        ...
        FFRoute(
          name: 'ChonKiemKe',
          path: '/chonKiemKe',
          builder: (context, params) => ChonKiemKeWidget(
            gusId: params.getParam(
              'gusId',
              ParamType.int,
            ),
        ...
        FFRoute(
          name: 'ChiTietKiemKe',
          path: '/chiTietKiemKe',
          builder: (context, params) => ChiTietKiemKeWidget(
            stoName: params.getParam(
              'stoName',
              ParamType.String,
            ),
            inventoryDate: params.getParam(
              'inventoryDate',
              ParamType.String,
            ),
            ...
            pihId: params.getParam(
              'pihId',
              ParamType.int,
            ),
            pihNumber: params.getParam(
              'pihNumber',
              ParamType.String,
            ),
          ),

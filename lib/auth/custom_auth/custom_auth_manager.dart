...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    lumosAuthUserSubject.add(
      LumosAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<LumosAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  LumosAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = LumosAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    lumosAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
